<div component="composer" class="composer<!-- IF resizable --> resizable<!-- ENDIF resizable --><!-- IF !isTopicOrMain --> reply<!-- ENDIF !isTopicOrMain -->">
		...
		<div class="category-tag-row">
			<div class="btn-toolbar formatting-bar">
				<ul class="formatting-group">
					...
					<li>
						<div class="form-check" style="position: relative; display: inline-block;">
							<input class="form-check-input" type="checkbox" value="" id="postAnonCheckbox">
							<label class="form-check-label" for="postAnonCheckbox">
								Post anonymous
							</label>
							<span class="custom-tooltip" style="visibility: hidden; background-color: #555; color: #fff; text-align: center; padding: 5px 10px; border-radius: 4px; position: absolute; z-index: 1; bottom: 125%; left: 50%; margin-left: -60px; opacity: 0; transition: opacity 0.3s;"
							onmouseover="this.style.visibility='visible'; this.style.opacity='1';"
							onmouseout="this.style.visibility='hidden'; this.style.opacity='0';">
								This post will not display your name
							</span>
						</div>
					</li>
	...
	<style>
	.form-check:hover .custom-tooltip {
		visibility: visible;
		opacity: 1;
	}
	</style>
