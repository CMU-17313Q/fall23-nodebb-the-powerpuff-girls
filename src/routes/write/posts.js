...
module.exports = function () {
    ...
    setupApiRoute(router, 'put', '/:pid/addtag', [...middlewares, middleware.assert.post], controllers.write.posts.addtag);
    setupApiRoute(router, 'delete', '/:pid/addtag', [...middlewares, middleware.assert.post], controllers.write.posts.untag);
