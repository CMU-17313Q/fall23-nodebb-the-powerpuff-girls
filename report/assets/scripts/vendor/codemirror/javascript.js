...
CodeMirror.defineMode('javascript', (config, parserConfig) => {
    ...
    const keywords = (function () {
        ...
        const A = kw('keyword a'); const B = kw('keyword b'); const
            C = kw('keyword c');
        const operator = kw('operator'); const
    ...
    function jsTokenBase(stream, state) {
        ...
        stream.eatWhile(/[\w\$_]/);
        const word = stream.current(); const
    ...
    return {
        ...
        indent: function (state, textAfter) {
            ...
            const firstChar = textAfter && textAfter.charAt(0); let
                { lexical } = state;
