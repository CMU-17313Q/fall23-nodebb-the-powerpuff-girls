(function () {
    ...
    // Determine effective options based on given values and defaults.
        const options = {}; const
            { defaults } = CodeMirror.simpleHint;
        for (const opt in defaults) if (defaults.hasOwnProperty(opt)) options[opt] = (givenOptions && givenOptions.hasOwnProperty(opt) ? givenOptions : defaults)[opt];
