        ...
        dialog(cm, queryDialog, 'Search for:', (query) => {
            cm.operation(() => {
                ...
                if (cm.lineCount() < 2000) { // This is too expensive on big documents.
                    for (let cursor = getSearchCursor(cm, state.query); cursor.findNext();) state.marked.push(cm.markText(cursor.from(), cursor.to(), { className: 'CodeMirror-searching' }));
                }
